...
const ApplyForm = () => {
    ...
    return (
        <div className='ApplyForm'>
            {/* Apply form start----------------------------------------------------------------------------------------------------------------- */}
            <div className="Apply_form top_pre">

                <div className="pre_title">
                    <h1> Apply form Details</h1>
                </div>
                ...
                <div className="pre_Img">
                    <div className="img">
                        <img src={data.img} alt="apply-form-img" onClick={handleImageClick} />
                    </div>
                </div>
                        ...
                        <div className="detail">
                            ...
                            <div className="center">
                                ...
                                <div className="p_inputbox">
                                    <span className="span"> Form id : </span>
                                    {isEditing ? (
                                        <div>
                                ...
                                <div className="p_inputbox">
                                    ...
                                    {isEditing ? (
                                        <div>
                                            <span className="hint">{data?.AF_title ?? ''} </span>
                                            <input
                                                type="text"
                                                name="AF_title"
                                                value={UpdateData.AF_title}
                                                onChange={handleInputChange}
                                            />
                                ...
                                <div className="p_inputbox">
                                    ...
                                    {isEditing ? (
                                        <div>
                                            <span className="hint_Descrip">{data?.AF_descrip ?? ''} </span>
                                            <textarea
                                                name="AF_descrip"
                                                type="text"
                                                value={UpdateData.AF_descrip}
                                                onChange={handleInputChange}
                                            />
